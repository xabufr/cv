...
\cvitem{Langages}{Kotlin, Python 3, JavaScript, TypeScript, HTML, CSS, SQL, notions de Clojure \& Haskell}
...
\begin{itemize}
    ...
    \item Écriture d'un moteur de Web-Scraping, création d'un pseudo-langage descriptif dédié,
...
\cventry{2012}{Développeur Web}{Goûts de Web}{Bordeaux}{Stage 7 semaines}{Développement d'un site web de petites annonces --- \url{marseille-culture13.fr}}
\cventry{2010}{Développeur}{EPSI}{Bordeaux}{Stage 7 semaines}{Développement d'une application de gestion des absences et des notes pour les enseignants}
