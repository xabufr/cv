...
\cventry{2018--2019}{Développeur fullstack}{Corporama}{}{}{Développement et maintenance de Corporama -- {\tiny Erlang/OTP, jQuery }
  \begin{itemize}
  \item Développement de nouvelles fonctionnalités, maintient/correction de bugs
  \item Peer-review
  \item Support client
...
\begin{itemize}
    ...
    \item Début de moteur de recherche d'image (Content Based Image Retrieving) et autres missions de R\&D {\tiny -- C++, Python},
      {\item Écriture d'un moteur de web-scraping
        --
        ...
        Ce projet a été utilisé en interne jusqu'à l'arrêt de KeepAlert {\tiny Typescript}
        \begin{itemize}
        \item Gestion des sites dynamiques, des évènements asynchrones, du parallélisme,
        \item Gestion de plusieurs navigateurs (phantomJS/SlimerJS, Electron, Google Chrome + DevTools protocol), 
        ...
        \item Création d'une plateforme SaaS avec versionning des scénarios de scraping, gestion des récurrences pour des lancements programmés, API documentée avec Swagger, interface web en Polymer 1.0, authentification OAuth2/JWT {\tiny AWS, AWS EC2, AWS Lambda, Kubernetes, beanstalkd, Java/Spring Boot}
        \end{itemize}
      }
      {\item Création de la version 2 de la plate-forme KeepAlert.
        \\
        KeepAlert étant trop vieillissant - aussi bien en terme d'interface que de capacités backend de récupération des données - une refonte complète a été entamée
        Bien que menée à bien et fonctionnelle en interne, cette nouvelle version n'est jamais sortie par manque de moyens.
        \\
        Étant le seul développeur disponible à ce moment là, j'ai assumé la quasi-totalité des développements/administration système/architecture.
...
\begin{itemize}
    ...
    \item Développement d'une solution OCR pour extraction de données textuelles {\tiny -- Bash, gOCR},
    \item Création d'un système de classification de domaines/site web avec machine learning en Java 7/Mallet,
    ...
    \item Migration de la production des études KeepAlert dans le Cloud d'Amazon grâce à Hadoop pour en accélérer la production et permettre de récolter plus de données {\tiny -- Java, Hadoop, ElasticSearch},
    \item Écriture d'un service dédié à l'orchestration des clusters Hadoop sur AWS afin d'en optimiser l'utilisation et les coûts {\tiny Java/DropWizard/MySQL/Angular 1},
